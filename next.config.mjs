...
function legacyCoverageRedirects() {
  const serviceRedirects = [
    ...
    {
      source: "/kashf-tasribat-al-khazanat-jeddah",
      destination: "/services/kashf-tasribat-al-khazanat-jeddah",
      permanent: true,
    },
    {
      source: "/kashf-tasribat-al-masabih-jeddah",
    ...
    {
      source: "/azl-khazanat-jeddah",
      destination: "/services/azl-khazanat-jeddah",
      permanent: true,
    },
    {
    ...
    {
      source: "/azl-hamamat-jeddah",
      destination: "/services/azl-hamamat-jeddah",
      permanent: true,
    },
    {
      source: "/azl-epoxy-jeddah",
      destination: "/services/azl-epoxy-jeddah",
      permanent: true,
    },
  ];
  try {
