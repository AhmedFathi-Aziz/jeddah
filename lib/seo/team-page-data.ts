...
export const TEAM_SEO = {
  title: "فريق العمل — متخصصو كشف التسربات والعزل",
  description:
    "تعرّف على فريق جدة للتسربات والعزل: مهندسون وفنيون بخبرة 6–12 سنة في كشف التسربات بدون تكسير وعزل الأسطح والخزانات بجدة.",
  keywords: [
    "فريق كشف تسربات جدة",
    "مهندس عزل أسطح جدة",
