...
export const INSULATION_SEO = {
  title: "شركة عزل بجدة | عزل مائي وحراري للأسطح",
  description:
    "شركة عزل بجدة: عزل أسطح وخزانات وحمامات — فوم وبيتومين وإيبوكسي، ضمان 10 سنوات، معاينة مجانية. احجز فريقنا المتخصص الآن.",
  keywords: [
    "شركة عزل بجدة",
