...
export const ABOUT_SEO = {
  title: "من نحن — خبرة كشف التسربات والعزل",
  description:
    "تعرف على جدة للتسربات والعزل: أكثر من 500 مشروع في جدة، 10+ سنوات خبرة، أجهزة كشف حديثة، وضمان يصل إلى 10 سنوات على العزل.",
  keywords: [
