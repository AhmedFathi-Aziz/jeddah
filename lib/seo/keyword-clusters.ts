...
export const KEYWORD_TOPICS: KeywordTopic[] = [
  ...
  { keyword: "عزل إيبوكسي بجدة", href: "/services/azl-epoxy-jeddah", category: "insulation" },
  { keyword: "عزل إيبوكسي جدة", href: "/services/azl-epoxy-jeddah", category: "insulation" },
  { keyword: "شركة عزل إيبوكسي بجدة", href: "/services/azl-epoxy-jeddah", category: "insulation" },
  { keyword: "سعر عزل إيبوكسي بجدة", href: "/services/azl-epoxy-jeddah", category: "insulation" },
  { keyword: "طلاء إيبوكسي للخزانات", href: "/services/azl-epoxy-jeddah", category: "insulation" },
  ...
  { keyword: "عزل خزانات إيبوكسي", href: "/services/azl-epoxy-jeddah", category: "insulation" },
