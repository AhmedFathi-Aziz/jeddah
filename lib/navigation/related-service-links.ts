...
function baseHrefsForPath(normalized: string): string[] {
  ...
  const map: Record<string, string[]> = {
    ...
    "/insulation": ["/", "/services/azl-ashtof-jeddah", "/leak-detection", "/insulation-services/foam-thermal-waterproof-insulation", "/insulation-services/tank-epoxy-insulation", "/blog/عزل-أسطح-بجدة", "/services", "/coverage", "/contact"],
