...
export const HUB_LINKS: InternalLink[] = [
  ...
  },
  {
    ...
    description: "إيبوكسي داخلي، عزل خارجي، وحقن للشروخ — معاينة مجانية وضمان.",
    tags: ["عزل", "خزان", "خزانات", "إيبوكسي", "جدة", "علوي", "أرضي", "حقن"],
  },
  {
  ...
  {
    href: "/services/azl-harari-jeddah",
    title: "عزل حراري بجدة",
    description: "فوم بولي يوريثان وعزل أسطح وخزانات خارجية — خفّض فاتورة التكييف مع معاينة مجانية.",
    tags: ["عزل", "حراري", "فوم", "أسطح", "خزان", "جدة", "تكييف", "طاقة"],
  },
  {
    href: "/services/azl-maei-jeddah",
    title: "عزل مائي بجدة",
    description: "لفائف بيتومين، سيكو بروف، وإيبوكسي للفلل والعمائر والخزانات — معاينة مجانية وضمان.",
    tags: ["عزل", "مائي", "بيتومين", "سيكو بروف", "إيبوكسي", "جدة", "خزان", "حمام"],
  },
  {
