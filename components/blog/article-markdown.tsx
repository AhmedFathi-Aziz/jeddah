  ...
  return (
    <div
      className={cn(
        ...
        "prose-p:max-w-none prose-p:text-base prose-p:leading-[1.85] prose-p:text-muted-foreground md:prose-p:text-[1.0625rem]",
        "prose-headings:mt-10 prose-headings:mb-4 prose-h2:mt-12",
