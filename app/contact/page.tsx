...
export const metadata: Metadata = buildPageMetadata({
  title: "اتصل بنا | كشف تسربات وعزل المياه في جدة — طوارئ ومعاينة مجانية",
  description:
    "اتصل بهاتف أو واتساب لحجز كشف تسربات أو عزل في جدة: فحص إلكتروني بدون تكسير، عزل فوم وخزانات، استجابة لطوارئ التسرب، ومعاينة مجانية في كل الأحياء.",
  path: "/contact",
