...
const STATIC_PUBLIC_PAGES: StaticSitemapEntry[] = [
  ...
  { path: "/team", changeFrequency: "monthly", priority: 0.86 },
  ...
  { path: "/services/azl-maei-jeddah", changeFrequency: "monthly", priority: 0.9 },
  ...
  { path: "/services/azl-epoxy-jeddah", changeFrequency: "monthly", priority: 0.9 },
